        ...
        <div class="card-body">
          <div class="container-fluid">
            <div class="card card-header" >
              <h3 class="card-tittle">Formulario editar usuario</h3>
            </div>
            <div class="card-body">
              <form role="form">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control" v-model="fillEditarUsuario.cUserCode" @keyup.enter="setEditarUsuario">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
    ...
    methods:{
      getUsuarioById(){
        ...
        axios.get(url, {
          ...
          this.fillEditarUsuario.cUserCode = response.data[0].user_code;
      ...
      validarRegistrarUsuario(){
        ...
        if(!this.fillEditarUsuario.cUserCode){
      ...
      setGuardarUsuario(nIdFile){
        ...
        axios.post(url, {
          ...
          'cUserCode': this.fillEditarUsuario.cUserCode,
      ...
      limpiarCriterios(){
        ...
        this.fillEditarUsuario.cUserCode = '';
